...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PreguntaEnergia.pregunta_en'
        db.add_column('familias_preguntaenergia', 'pregunta_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TipoCocina.nombre_en'
        db.add_column('familias_tipococina', 'nombre_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PreguntaEnergia.pregunta_en'
        db.delete_column('familias_preguntaenergia', 'pregunta_en')

        # Deleting field 'TipoCocina.nombre_en'
        db.delete_column('familias_tipococina', 'nombre_en')
    ...
    models = {
        ...
        'familias.preguntaenergia': {
            ...
            'pregunta_en': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        'familias.tipococina': {
