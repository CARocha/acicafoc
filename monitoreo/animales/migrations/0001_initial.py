...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('animales_animales', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('animales', ['Animales'])

        # Adding model 'ProductoAnimal'
        db.create_table('animales_productoanimal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('unidad', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('animales', ['ProductoAnimal'])

        # Adding model 'AnimalesFinca'
        db.create_table('animales_animalesfinca', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('animales', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['animales.Animales'])),
            ('cantidad', self.gf('django.db.models.fields.FloatField')()),
            ('produccion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['animales.ProductoAnimal'])),
        ...
        db.send_create_signal('animales', ['AnimalesFinca'])


    def backwards(self, orm):
        
        # Deleting model 'Animales'
        db.delete_table('animales_animales')

        # Deleting model 'ProductoAnimal'
        db.delete_table('animales_productoanimal')

        # Deleting model 'AnimalesFinca'
        db.delete_table('animales_animalesfinca')
    ...
    models = {
        ...
        'animales.animalesfinca': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'produccion': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['animales.ProductoAnimal']"}),
