...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductoAnimal.nombre_en'
        db.add_column('animales_productoanimal', 'nombre_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Animales.nombre_en'
        db.add_column('animales_animales', 'nombre_en',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductoAnimal.nombre_en'
        db.delete_column('animales_productoanimal', 'nombre_en')

        # Deleting field 'Animales.nombre_en'
        db.delete_column('animales_animales', 'nombre_en')
    ...
    models = {
        'animales.animales': {
            ...
            'nombre_en': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'})
        },
