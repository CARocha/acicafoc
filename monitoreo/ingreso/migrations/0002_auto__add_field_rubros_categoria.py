...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('ingreso_rubros', 'categoria', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Rubros.categoria'
        db.delete_column('ingreso_rubros', 'categoria')
