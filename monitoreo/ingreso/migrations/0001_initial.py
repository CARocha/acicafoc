...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Rubros'
        db.create_table('ingreso_rubros', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('unidad', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('ingreso', ['Rubros'])

        # Adding model 'IngresoFamiliar'
        db.create_table('ingreso_ingresofamiliar', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rubro', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ingreso.Rubros'])),
            ('cantidad', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('consumida', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ...
        db.send_create_signal('ingreso', ['IngresoFamiliar'])


    def backwards(self, orm):
        
        # Deleting model 'Rubros'
        db.delete_table('ingreso_rubros')

        # Deleting model 'IngresoFamiliar'
        db.delete_table('ingreso_ingresofamiliar')
    ...
    models = {
        ...
        'ingreso.ingresofamiliar': {
            ...
            'rubro': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ingreso.Rubros']"})
        },
        'ingreso.rubros': {
