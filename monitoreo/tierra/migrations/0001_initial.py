...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Uso'
        db.create_table('tierra_uso', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('tierra', ['Uso'])

        # Adding model 'UsoTierra'
        db.create_table('tierra_usotierra', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tierra', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tierra.Uso'], null=True, blank=True)),
        ...
        db.send_create_signal('tierra', ['UsoTierra'])


    def backwards(self, orm):
        
        # Deleting model 'Uso'
        db.delete_table('tierra_uso')

        # Deleting model 'UsoTierra'
        db.delete_table('tierra_usotierra')
    ...
    models = {
        ...
        'tierra.usotierra': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tierra': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tierra.Uso']", 'null': 'True', 'blank': 'True'})
        }
    }

    complete_apps = ['tierra']
