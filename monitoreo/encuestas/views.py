...
def generales(request):
    ...
    for division in CHOICE_EDUCACION:
        conteo = Encuesta.objects.filter(educacion__sexo=division[0]).aggregate(conteo=Count('educacion__sexo'))['conteo']
        total += conteo
    ...
    for escuela in CHOICE_EDUCACION:
        ...
        porcentaje = round(saca_porcentajes(conteo,total),2)
