...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('encuestas_encuesta', 'year', self.gf('django.db.models.fields.IntegerField')(default=2010), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Encuesta.year'
        db.delete_column('encuestas_encuesta', 'year')
