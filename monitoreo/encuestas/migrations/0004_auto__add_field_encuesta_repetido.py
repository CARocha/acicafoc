...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Encuesta.repetido'
        db.add_column('encuestas_encuesta', 'repetido',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Encuesta.repetido'
        db.delete_column('encuestas_encuesta', 'repetido')
    ...
    models = {
        ...
        'encuestas.encuesta': {
            ...
            'repetido': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
