...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Graves.nombre_en'
        db.add_column('riesgos_graves', 'nombre_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Fenomeno.nombre_en'
        db.add_column('riesgos_fenomeno', 'nombre_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Causa.nombre_en'
        db.add_column('riesgos_causa', 'nombre_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PreguntaRiesgo.nombre_en'
        db.add_column('riesgos_preguntariesgo', 'nombre_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Graves.nombre_en'
        db.delete_column('riesgos_graves', 'nombre_en')

        # Deleting field 'Fenomeno.nombre_en'
        db.delete_column('riesgos_fenomeno', 'nombre_en')

        # Deleting field 'Causa.nombre_en'
        db.delete_column('riesgos_causa', 'nombre_en')

        # Deleting field 'PreguntaRiesgo.nombre_en'
        db.delete_column('riesgos_preguntariesgo', 'nombre_en')
    ...
    models = {
        ...
        'riesgos.fenomeno': {
            ...
            'causa': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['riesgos.Causa']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'nombre_en': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
        ...
        'riesgos.riesgos': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pregunta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['riesgos.PreguntaRiesgo']", 'null': 'True', 'blank': 'True'}),
        ...
        'riesgos.vulnerable': {
            ...
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['encuestas.Encuesta']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'motivo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['riesgos.Fenomeno']"}),
            'respuesta': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['riesgos.Graves']", 'null': 'True', 'blank': 'True'})
        }
    }

    complete_apps = ['riesgos']