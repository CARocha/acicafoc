...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Alimentos.nombre_en'
        db.add_column('seguridad_alimentos', 'nombre_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Alimentos.nombre_en'
        db.delete_column('seguridad_alimentos', 'nombre_en')
