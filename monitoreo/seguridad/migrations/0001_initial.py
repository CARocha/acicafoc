...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('seguridad_seguridad', (
            ...
            ('producen', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('compran', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('consumen', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('consumen_invierno', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
    ...
    models = {
        ...
        'seguridad.seguridad': {
            ...
            'compran': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'consumen': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'consumen_invierno': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['encuestas.Encuesta']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'producen': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        }
    }
