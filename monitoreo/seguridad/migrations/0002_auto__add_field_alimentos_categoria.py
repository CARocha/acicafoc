...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('seguridad_alimentos', 'categoria', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Alimentos.categoria'
        db.delete_column('seguridad_alimentos', 'categoria')
