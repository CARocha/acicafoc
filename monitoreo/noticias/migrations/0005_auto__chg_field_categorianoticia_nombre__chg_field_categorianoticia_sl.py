...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('noticias_categorianoticia', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=240, unique=True, null=True))

        # Changing field 'CategoriaNoticia.slug'
        db.alter_column('noticias_categorianoticia', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=250))


    def backwards(self, orm):
        
        # Changing field 'CategoriaNoticia.nombre'
        db.alter_column('noticias_categorianoticia', 'nombre', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200, null=True))

        # Changing field 'CategoriaNoticia.slug'
        db.alter_column('noticias_categorianoticia', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=220, unique=True))
    ...
    models = {
        ...
        'noticias.categorianoticia': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '240', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
