...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('noticias_categorianoticia', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=220))


    def backwards(self, orm):
        
        # Changing field 'CategoriaNoticia.slug'
        db.alter_column('noticias_categorianoticia', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=40, unique=True))
    ...
    models = {
        ...
        'noticias.categorianoticia': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '220', 'db_index': 'True'})
        },
        'noticias.noticia': {
