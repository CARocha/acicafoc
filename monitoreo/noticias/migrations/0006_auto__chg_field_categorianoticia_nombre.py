...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('noticias_categorianoticia', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=250, unique=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'CategoriaNoticia.nombre'
        db.alter_column('noticias_categorianoticia', 'nombre', self.gf('django.db.models.fields.CharField')(unique=True, max_length=240, null=True))
