...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TipoOrganizacion.nombre_en'
        db.add_column('genero_tipoorganizacion', 'nombre_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActividadHogar.nombre_en'
        db.add_column('genero_actividadhogar', 'nombre_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActividadFinca.nombre_en'
        db.add_column('genero_actividadfinca', 'nombre_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TipoOrganizacion.nombre_en'
        db.delete_column('genero_tipoorganizacion', 'nombre_en')

        # Deleting field 'ActividadHogar.nombre_en'
        db.delete_column('genero_actividadhogar', 'nombre_en')

        # Deleting field 'ActividadFinca.nombre_en'
        db.delete_column('genero_actividadfinca', 'nombre_en')
