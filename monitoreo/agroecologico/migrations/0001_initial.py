...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('agroecologico_manejoagro', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('unidad', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('agroecologico', ['ManejoAgro'])

        # Adding model 'OpcionesManejo'
        db.create_table('agroecologico_opcionesmanejo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uso', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['agroecologico.ManejoAgro'], null=True, blank=True)),
            ('nivel', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('menor_escala', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('mayor_escala', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ...
        db.send_create_signal('agroecologico', ['OpcionesManejo'])


    def backwards(self, orm):
        
        # Deleting model 'ManejoAgro'
        db.delete_table('agroecologico_manejoagro')

        # Deleting model 'OpcionesManejo'
        db.delete_table('agroecologico_opcionesmanejo')


    models = {
        'agroecologico.manejoagro': {
            'Meta': {'object_name': 'ManejoAgro'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'unidad': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        'agroecologico.opcionesmanejo': {
            'Meta': {'object_name': 'OpcionesManejo'},
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['encuestas.Encuesta']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mayor_escala': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'menor_escala': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'nivel': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'uso': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['agroecologico.ManejoAgro']", 'null': 'True', 'blank': 'True'}),
