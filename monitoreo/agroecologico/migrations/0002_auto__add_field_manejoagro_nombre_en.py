...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ManejoAgro.nombre_en'
        db.add_column('agroecologico_manejoagro', 'nombre_en',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ManejoAgro.nombre_en'
        db.delete_column('agroecologico_manejoagro', 'nombre_en')
