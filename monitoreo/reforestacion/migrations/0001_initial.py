...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('reforestacion_actividad', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('reforestacion', ['Actividad'])

        # Adding model 'Reforestacion'
        db.create_table('reforestacion_reforestacion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('reforestacion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reforestacion.Actividad'])),
        ...
        db.send_create_signal('reforestacion', ['Reforestacion'])


    def backwards(self, orm):
        
        # Deleting model 'Actividad'
        db.delete_table('reforestacion_actividad')

        # Deleting model 'Reforestacion'
        db.delete_table('reforestacion_reforestacion')
    ...
    models = {
        ...
        'reforestacion.reforestacion': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reforestacion': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['reforestacion.Actividad']"}),
            'respuesta': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        }
    }

    complete_apps = ['reforestacion']
