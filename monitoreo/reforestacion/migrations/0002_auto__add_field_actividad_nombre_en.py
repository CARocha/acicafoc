...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Actividad.nombre_en'
        db.add_column('reforestacion_actividad', 'nombre_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Actividad.nombre_en'
        db.delete_column('reforestacion_actividad', 'nombre_en')
